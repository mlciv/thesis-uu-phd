...
\Paragraph{Constrained Conditional Models} Besides the graphical
...
\Paragraph{Declarative Constraints in Deep Learning} Recently, to inject
...
\Paragraph{Contetualized Representation and Contextualizing Models}
