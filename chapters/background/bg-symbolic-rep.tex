...
the surface substring in the sentence, which is \kw{anchoring} to
...
For easy reference, in~\autoref{tbl:bg:summary-broad-coverage}, we summarize the background of
