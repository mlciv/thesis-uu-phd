...
$\mathcal{F}_T$~().
%
%If we extend the GMGRU with a multiplicative multihead attention
...
%\REC performance, suggesting that the multihead word attention
...
\toprule
\hline
 Ablation                                             & Options                      & macro & \FN  & \CHANGE & \SUSTAIN \\ \midrule
...
\multirow{2}{*}{\parbox{2cm}{sentence \quad attention}} & + \self                      & 53.9  & 89.2 & 39.1    & 33.2     \\
                                                      & + \anchor                    & 53.0  & 88.2 & 38.9    & 32.0     \\ \hline
\bottomrule
